...
\newcommand{\thesisdate}{November 26, 2025}
...
\item Trirattananurak, C., Usanavasin, S., Damrongrat, C., \& Okumura, M. (2025). 
AI Assisted Grading Framework for Thai-Language Written Exam Questions based on LLM and Rule-Based Reasoning Approach. 
Presented at \textit{The 13th ASEAN Workshop on Information Science and Technology (AWIST 2025)}, Japan. Proceedings forthcoming.

\item Aueawatthanaphisut, A. \& Trirattananurak, C. (2025). 
CoachGPT-TH: Feasible Thai-language, software-only micro-coaching for physical activity using LLM-RAG with bandit personalization and fairness auditing. 
Presented at \textit{South-East Asia Physical Activity Conference (SEAPAC 2025)}, Bangkok, Thailand. Proceedings forthcoming.

\item Aueawatthanaphisut, A. \& Trirattananurak, C. (2025). 
A Unified Semantic Framework for Mitigating Device and Data Heterogeneity in IoT Systems. 
Presented at \textit{The 20th International Joint Symposium on Artificial Intelligence and Natural Language Processing (iSAI-NLP 2025)}, November 12–14, 2025. Proceedings forthcoming.
